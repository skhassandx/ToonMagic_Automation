...
def upload_to_youtube(video_path, title, description, playlist_id=None):
    print("🚀 Uploading to YouTube with Full SEO Optimization & Location (Comments ON)...")
    ...
    try:
        # 🌟 স্কোপ যুক্ত করা হলো (ভিডিও আপলোড এবং প্লেলিস্ট ম্যানেজমেন্টের জন্য)
        creds = Credentials(
            token=None,
        ...
        # 🌟 পাওয়ারফুল ট্যাগ (৫০০ ক্যারেক্টারের নিরাপদ লিমিটের মধ্যে, প্রায় ৪০০ ক্যারেক্টার)
        viral_tags = [
        ...
        # 🌟 ডাইনামিক টাইটেল ও ডেসক্রিপশন (জেমিনাই থেকে আসা ডেটার সাথে SEO ট্যাগ যুক্ত করা হলো)
        final_title = f"{title[:75]} ✨ | Bangla Cartoon | #Shorts"  # ইউটিউব টাইটেল লিমিট ১০০ ক্যারেক্টার, তাই সেফ রাখা হলো
...
"""
        ...
        # 🌟 প্লেলিস্টে যুক্ত করার লজিক (Error Handling সহ)
        if playlist_id:
            try:
                ...
                print(f"⚠️ Video uploaded, but failed to add to playlist (Check if Playlist ID is correct): {e}")
